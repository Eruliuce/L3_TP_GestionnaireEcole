...
void ll_insert(LinkedList*, void (*foncteurCond)(), void* cond); //insert un élément dans la liste selon une condition d'emplacement (pour obtenir une liste triée)
//void ll_remove(LinkedList*, ); //retire un élément de la liste selon une condition
//void ll_exec(LinkedList*, ); //appelle une fonction sur tous les éléments de la liste
